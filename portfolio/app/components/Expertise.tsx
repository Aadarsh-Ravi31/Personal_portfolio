  ...
  return (
    <section id="expertise" className="bg-[#FEFAF6] py-20 px-6 sm:px-10">
      ...
      >
        ...
        {/* Icons with Loader */}
        <div className="bg-gray-100 p-6 rounded-2xl shadow-md max-h-60 overflow-y-auto min-h-[150px] flex items-center justify-center">
          {loading ? (
            <div className="animate-spin rounded-full h-8 w-8 border-t-4 border-[#15212C] border-opacity-50"></div>
          ) : (
            <motion.div
              key={activeTab}
