  ...
  return (
    ...
    >
      <div className="flex items-baseline gap-4 sm:gap-6">
        <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl">{label}</h2>
...
export function ImdbDeepDive() {
  ...
  return (
    <>
      ...
      <Section id="architecture" label="Architecture" kicker="ADF to Power BI" wide>
        <div className="overflow-hidden rounded-brand border border-line bg-white">
          ...
          >
            <Image
              src="/images/imdb-architecture.svg"
              alt="IMDb analytics architecture: seven raw IMDb datasets are profiled and cleaned in Alteryx and Python, orchestrated by Azure Data Factory into a two-layer Snowflake warehouse of staging and curated dimensional tables, and served through Power BI and Tableau dashboards, with row-count reconciliation and primary-key uniqueness checks across every layer."
              width={1160}
              height={470}
      ...
      <Section id="tuning" label="Tuning & trust" kicker="Where the warehouse is won">
        ...
        <p className="mt-8 max-w-measure text-sm text-ink-soft">
          A star schema is the easy half. On Snowflake the win is in how the
          91M-row cast/crew bridge is loaded and clustered, and in the
          reconciliation checks that prove the modelled layer still matches the
          raw load — the first things worth asking about in a warehouse review.
        </p>
      </Section>
