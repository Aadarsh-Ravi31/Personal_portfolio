...
import {
  ...
  TRACES,
  type Trace,
} from "@/app/lib/podcastiq/podcastiq-traces";
import {
  CHANNELS,
  DEEP_DIVE,
  NEIGHBOURHOOD,
  NODE_COLOURS,
} from "@/app/lib/podcastiq/podcastiq-dashboard";
    ...
    <div className="console-surface overflow-hidden rounded-[18px] bg-bg ring-1 ring-black/20 shadow-[0_40px_80px_-40px_rgba(0,0,0,0.55)]">
      ...
      <div className="grid lg:grid-cols-[minmax(0,17rem)_1fr]">
        ...
        <div id="console-view-graph" role="tabpanel" aria-labelledby="tab-graph" className="p-5 sm:p-6">
          <p className="font-serif text-lg text-ink">Knowledge Graph Explorer</p>
        ...
        >
          <p className="font-serif text-lg text-ink">Channel Dashboard</p>
          <p className="mt-1 text-xs text-ink-soft">
            ...
            <dl className="mt-4 grid grid-cols-3 gap-3">
              {[
                ...
                <div key={k} className="rounded-brand-sm border border-line bg-bg p-3 text-center">
                  <dd className="font-serif text-base text-ink">{v}</dd>
